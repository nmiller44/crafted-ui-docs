...
<CodePreview code={`
import { Page } from "crafted-ui";
import { Section } from "crafted-ui";
...
`}>
    <Page title="My Page" subtitle="Page description">
        <Section title="Content Section" prose={false}>
            <p>Page content goes here</p>
        </Section>
    </Page>
</CodePreview>
...
<CodePreview code={`
import { PageHeader } from "crafted-ui";
...
<Page title="Layout Demo" subtitle="Shows container and spacing behavior">
  <div className="p-4 bg-primary/10 rounded-md">
    <p className="text-sm">Container content with automatic width constraints</p>
  </div>
  <div className="p-4 bg-secondary/10 rounded-md">
    <p className="text-sm">Automatic spacing between content blocks (space-y-12)</p>
  </div>
</Page>
`}>
...
`}>
    ...
    <Section>
        ...
        Combine a Badge with the header title and include action buttons using a custom header structure:
    </Section>
...
<PageHeader subtitle="Manage your craft brewery inventory">
  <div className="flex items-start gap-3">
    <h1 className="text-4xl font-bold tracking-tight">Barrel Aged Collection</h1>
    <Badge clr="warning">Limited</Badge>
  </div>
  <div className="flex gap-2">
    <Button>View Details</Button>
    <Button clr="primary">Add to Collection</Button>
  </div>
</PageHeader>
`}>
    <PageHeader>
        <div class="flex items-start gap-3">
            <Heading1 title="Barrel Aged Collection" 
                      subtitle="Manage your craft brewery inventory" />
            <Badge clr="warning">Limited</Badge>
        </div>
        <div class="flex gap-2">
            <Button>View Details</Button>
...
`}>
    <Page 
      ...
      title="Custom Width"
    >
        <Section title="Narrower Container" prose={false}>
            <p>Content with custom maximum width</p>
        </Section>
    </Page>
</CodePreview>
...
>
  <Button clr="secondary">Action</Button>
</PageHeader>
`}>
    <PageHeader 
      title="Styled Header" 
...
`}>
    <div class="space-y-0">
        <Page title="Mixed Layout">
            <Section title="Regular Content" prose={false}>
                <p>Standard container width</p>
            </Section>
        </Page>
        ...
        <div class="bg-muted py-12">
            <div class="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
                <Section title="Full-Width Section" prose={false}>
                    <p>Full-width background with contained content</p>
                </Section>
            </div>
        </div>
