...
<BaseSidebar title={frontmatter.title} description={frontmatter.description}>
    ...
    <Section title="Composite Components">
        ...
        ```tsx
        import { MetricTitle } from "crafted-ui";
        ...
        ```tsx
        import { MetricValue } from "crafted-ui";
        ...
        ```tsx
        import { MetricDiff } from "crafted-ui";
    ...
    <Section title="Custom Layouts">
        ...
        ```tsx
        import { Metric, MetricTitle, MetricValue, MetricDiff } from "crafted-ui";
    ...
    <Section title="Examples">
        ...
        ### Dashboard Metrics
        ```tsx
        import { Metric, Card, CardBody } from "crafted-ui";
