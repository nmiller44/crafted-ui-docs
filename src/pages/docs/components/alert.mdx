...
<BaseSidebar title={frontmatter.title} description={frontmatter.description}>
    ...
    <Section title="Overview">
        The Alert component provides a way to display important messages or notifications to users. It comes with several visual variants to denote different types of alerts: warning, danger, success, and info. This component is designed to provide contextual feedback and capture the user's attention when necessary.
    </Section>
    ...
    <Section title="Alert">
        ...
        | status | 'warning' \| 'danger' \| 'success' \| 'info' | 'warning' | Determines the visual style of the alert |
    ...
    <Section title="Examples">
        ...
        ```tsx
        <Alert title="Validation Errors" status="danger">
          <ul>
